...
void AInteractionFrameworkPlayerController::BeginPlay()
{
	...
	if (ShouldUseTouchControls() && IsLocalPlayerController())
	{
		...
		if (MobileControlsWidget)
		{
			...
			UE_LOG(LogInteractionFramework, Error, TEXT("Could not spawn mobile controls widget."));
...
bool AInteractionFrameworkPlayerController::ShouldUseTouchControls() const
{
